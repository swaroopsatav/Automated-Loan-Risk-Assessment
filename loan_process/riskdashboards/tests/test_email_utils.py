...
class EmailUtilsTest(TestCase):
    ...
    def test_send_model_performance_notification(self):
        ...
        result = async_to_sync(send_model_performance_notification)(self.model_log)
    ...
    def test_send_model_performance_notification_with_recipients(self):
        ...
        result = async_to_sync(send_model_performance_notification)(self.model_log, recipients=recipients)
    ...
    def test_send_model_performance_threshold_alert(self):
        ...
        result = async_to_sync(send_model_performance_threshold_alert)(
